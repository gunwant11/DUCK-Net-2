...
import cv2
folder_path = "/content/drive/MyDrive/DUCK-Net-2/Kvasir-SEG/" # Add the path to your data directory
...
def load_data(img_height, img_width, images_to_be_loaded, dataset):
    ...
    if dataset == 'kvasir':
        print('Loading Kvasir dataset',IMAGES_PATH)
